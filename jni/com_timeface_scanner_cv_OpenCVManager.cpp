#include <com_timeface_scanner_cv_OpenCVManager.h>
#include <scannerLite.hpp>

JNIEXPORT jobjectArray JNICALL Java_com_timeface_scanner_cv_OpenCVManager_nScan(JNIEnv *env, jclass obj, jstring prompt)
{
